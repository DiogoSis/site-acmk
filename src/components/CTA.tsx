  ...
  return (
    <section className="py-20 bg-gradient-to-br from-primary to-primary-dark relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-secondary/20 rounded-full" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/90 text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Agende uma <strong>aula experimental gratuita</strong> e descubra como o
            Karatê pode transformar a sua vida e a de sua família.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="#contato"
              className="inline-flex items-center justify-center gap-3 bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:-translate-y-1 border border-white/20"
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-white/80">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Turmas para todas as idades</span>
            </div>
            <div className="flex items-center gap-2">
              <svg
                className="w-5 h-5"
